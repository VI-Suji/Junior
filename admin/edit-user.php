...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$sql = "UPDATE register SET name=(:name), email=(:email), dob=(:dob), batch=(:batch), address=(:address), mobile=(:mobileno) WHERE id=(:idedit)";
										...
										<div class="panel-body">
											<form method="post" class="form-horizontal" enctype="multipart/form-data" name="imgform">
												...
												<div class="form-group">
													...
													<div class="col-sm-4">
														<input type="text" name="dob" class="form-control" required value="<?php echo htmlentities($result->dob); ?>">
													</div>
