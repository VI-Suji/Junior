						...
						<div class="col-sm-1 col-lg-12 col-md-12">
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									<?php 
                                            $flag="2";
											$sql = "SELECT * FROM register r WHERE r.flag=:flag AND r.batch=:batch";
											$query = $dbh->prepare($sql);
										...
										<tbody>
												...
												foreach ($results as $result) {				?>
                                                    ...
                                                    {?>
                                                    <a href="paid.php?confirm=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to Reject Payment')">Reject Payment <i class="fa fa-check-circle"></i></a> 
                                                    <?php } ?>
											...
											<?php $cnt = $cnt + 1;
                                                ...
                                                <div class="panel-heading">No body is paid</div>
                                            <?php } ?>
